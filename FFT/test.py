...
def create_video(mp3_path, out_path):
    PATH = mp3_path
    ...
    ani = animation.FuncAnimation(fig, update, init_func=init, frames=int(len(sample) / sr) * FPS - 1, interval=1 / FPS,
                                  blit=True)
